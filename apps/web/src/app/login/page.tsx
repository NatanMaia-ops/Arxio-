...
export default function LoginPage() {
	return (
		<div className="grid min-h-dvh grid-cols-1 bg-white px-6 text-[#1c1a17] md:grid-cols-2 md:px-14 lg:px-20">
			<section className="flex min-w-0 flex-col items-center pt-8 pb-6 md:pt-10 md:pr-12 md:pb-12 lg:pr-16">
				<div className="flex w-full min-w-0 max-w-xl flex-1 flex-col">
					...
					<div className="flex flex-1 flex-col justify-center gap-6 py-12 md:py-0">
						<h1
							className={`${displayFont.className} font-medium text-[#1c1a17] text-[34px] leading-[1.1] tracking-[-0.015em] md:text-[52px] md:leading-[1.08] lg:text-[60px]`}
						>
							Ideias que merecem tempo.
						</h1>

						<div className="flex flex-col gap-3">
							<p className="max-w-md text-[#57534e] text-lg leading-relaxed">
								Descubra novas perspectivas, acompanhe autores e publique aquilo
								que você aprendeu.
							</p>
			...
			<section className="flex min-w-0 items-center justify-center border-[#e7e5e1] border-t pt-6 pb-14 md:border-t-0 md:border-l md:py-14 md:pl-12 lg:pl-16">
				<LoginCard />
			</section>
		</div>
	);
