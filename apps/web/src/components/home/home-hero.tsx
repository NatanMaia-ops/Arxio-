	...
	return (
		<>
			...
			<div className="absolute inset-x-4 top-[88px] z-2 flex flex-col items-center text-center sm:top-20 lg:top-[102px]">
				<h1
					id="home-hero-title"
					className="max-w-[780px] font-home-display font-semibold text-[clamp(2.25rem,3.35vw,3.25rem)] text-black leading-[0.91] tracking-[-0.02em]"
				>
					Rede acadêmica para compartilhar estudos, projetos e conhecimento.
				</h1>

				<p className="mt-5 max-w-[421px] font-home-interface font-medium text-black/65 text-sm leading-5 lg:text-xs lg:leading-none">
