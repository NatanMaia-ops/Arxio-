...
import type { SessionReader } from "./http/auth.middleware";
...
export const readSession: SessionReader = (request) =>
	getSession(request, authConfig);
export const requireAuth = createRequireAuth(readSession);
